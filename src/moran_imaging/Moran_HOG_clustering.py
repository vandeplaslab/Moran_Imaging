...
from .local_global_spatial_autocorrelation import Moran_Local
from skimage.feature import hog
from sklearn.cluster import HDBSCAN, KMeans
from sklearn.preprocessing import StandardScaler
from .spatial_weights_matrix import define_spatial_weights_matrix
from tqdm import tqdm
from umap import UMAP


class Moran_HOG_SKD_clustering:
    def __init__(
        self,
        dataset,
        acquisition_mask,
        ...
        for mz_index in range(dataset.shape[1]):
            ...
            local_Moran_object = Moran_Local(
